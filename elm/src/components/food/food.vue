		...
		<div class="food" v-show="detailShow" ref="foodScroll">
			<div class="food-content">
				...
				<div class="food-description">
					...
					</div><div class="price"><span class="newPrice">¥{{food.price}}</span><span class="oldPrice" v-show="food.oldPrice">¥{{food.oldPrice}}</span></div>
				<div class="shpocart">
					<div class="shpocart-content"@click="cartcontralShowF" v-show="cartcontralShow===false ||food.count===0">
						加入购物车
					</div>
					<cartcontral @cartcontralCount="cartcontralCount" v-show="cartcontralShow===true " :food="food"  :show="cartcontralShow===true"/>
				</div>
					</div>
				<split />
...
<script>
	...
	export default {
		...
		methods: {
			...
			cartcontralCount(e){this.cartcontralShow=false
				console.log(e)
				if(this.food===1){
				
				}
			}
		,	cartcontralShowF(){this.cartcontralShow=true
			
			console.log('k')
// 				if (this.count >0) {this.cartcontralShow=true
// }
