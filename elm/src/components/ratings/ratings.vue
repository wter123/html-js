		...
		<div class="ratings-content">
			<div class="ratings-detail">
				...
				<div class="detail-right">
					<div class="right-top">
						...
						<div class="star-score">{{ratings.seller.serviceScore}}
						</div>
					</div>
			...
			<div class="ratings-two">
				<div class="ratings-wrapper">
					<ratingsselect :food='ratings' @foodShowb="ratingsShow" @ratingTypeSeed="sonRatingsType" />
				</div>
				<div class="ratings-content">
					<div class="content-wrapper">
						<li v-for="ratings in ratingsSelect()">
							<div class="avatar"><img :src="ratings.avatar" alt=""></div>
							<div class="ll"><div class="content">
								<div class="top"><span class="name">{{ratings.username}}</span>
									<span class="time">{{ratings.rateTime | formatDate}}</span></div>
								<div class="top-two"><span class="star">
										<star :size="36" :score='ratings.score'></star>
									</span><span v-show="ratings.deliveryTime" class="time-description">{{ratings.deliveryTime}}分钟送达</span></div>

								<div class="content-text" v-if="ratings.text">{{ratings.text}}</div>
								
							</div><div class="extra" v-if="ratings.recommend[0]"><span class="icon"></span><span class="food-name"><template
										 v-for="recommend in ratings.recommend"><span class="extra-name">{{ recommend}}</span></template></span></div></div>
