<template>
	<div class="v-header">
		...
		<div class="bulltin-wrapper" v-on:click="showDetail">
			...
			<span class="bulltin-text">{{sellerData.bulletin}}<span class="bulltin-right-arrow"><i class="icon-keyboard_arrow_right"> </i></span></span>
		</div>
...
<div class="background"><img src="./seller_avatar_256px.jpg" alt="" width ="100%"
			height="100%"></div>
	</div>
	<!--  url()   --->
</template>
